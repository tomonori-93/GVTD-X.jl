...
subroutine Wind_Retrieval( nr_org, nt_org, nz, rval_org, undef,  &
  &                          )
  ...
  integer, intent(in) :: smooth_r          !! resampled radial grid number from the original data
  integer, intent(in) :: smooth_t          !! resampled azimuthal grid number from the original data
  ...
  real, intent(in) :: undefobs             !! undefined value for the original Doppler radar data
